...
bool not_space(char x)	//判断是否 不是空格
{
	return !isspace(x);
}
...
void get_words(std::istream &in, std::vector<Words> &out,int &total)	//输入单词
{
	std::string s;
...
void output(int total,const std::vector<Words> &out)		//输出单词及次数
{
